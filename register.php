        ...
        <div class="row p-0 m-0">
          ...
          <section class="register_container d-flex pb-4">
            <form class="form d-flex flex-column bg-white">
              <div class="title">Register now for free and receive the latest properties by email</div>
              <div class="inputs mt-2">
                <input type="email" class="email w-100 border-0" placeholder="E-Mail Adresse: zB. meinemail@adresse.at">
                <input type="password" class="password w-100 border-0" minlength="4" maxlength="8" placeholder="Password: eg. 12345">
                <input type="text" class="repit_pass w-100 border-0" placeholder="Repeat Password">
                <div class="d-flex align-items-start gap-2 pt-2">
                  <input type="checkbox" name="pp" id="pp" class="privc_polic p-0 m-0 mt-1">
                  <label for="pp">Yes, I have read the <a href="privacy_policy.php">privacy policy</a> and agree to it.</label>
                </div>
              </div>
              <button class="register_btn d-flex mt-4 mb-4">to register</button>
              <span class="text-secondary">I already have a search agent</span>
              <a href="login.php">To Register</a>
            </form>
            <div class="mt-4">
          ...
          <!--======================== facility ========================-->
          <section class="facility mt-5 p-0">
            <div class="row p-0 m-0">
